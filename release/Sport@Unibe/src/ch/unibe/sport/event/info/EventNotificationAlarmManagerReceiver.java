...
public class EventNotificationAlarmManagerReceiver extends BroadcastReceiver {

	public static final String TAG = EventNotificationAlarmManagerReceiver.class.getName();
	private static final String SHOWN_KEY = "event_notification_shown";
	@Override
	public void onReceive(Context context, Intent intent) {
		...
		EventAttended attended = new EventAttended(context);
		...
		for (long id : courseIDs){
			...
			new EventNotification(context, new Event(context,(int)id)).show();
			shownIDs.add(id);
		}
	...
	public void setAlarm(Context context) {
		...
		Intent intent = new Intent(context, EventNotificationAlarmManagerReceiver.class);
