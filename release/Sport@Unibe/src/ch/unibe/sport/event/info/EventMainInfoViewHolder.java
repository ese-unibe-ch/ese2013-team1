...
public class EventMainInfoViewHolder {
	...
	public final TextView dayAttended;
	...
	public EventMainInfoViewHolder(EventMainInfoCardRelative card){
		...
		dayAttended = (TextView) card.findViewById(R.id.day_attended);
