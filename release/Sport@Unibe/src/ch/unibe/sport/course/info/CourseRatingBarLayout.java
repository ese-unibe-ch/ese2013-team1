...
public class CourseRatingBarLayout extends LinearLayout{
	public static final String TAG = CourseRatingBarLayout.class.getName();
	...
	public CourseRatingBarLayout(Context context, int stars) {
		super(context);
		this.stars = stars;
		init();
	}
